...
- `PLAYFAB_LEADERBOARD_STATS`: Optional comma-separated statistic names for the admin leaderboard probe. If omitted, the server tries a small list of common guesses.
